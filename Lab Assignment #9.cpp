...
//********************************************
ostream& operator << (ostream& os, Student& out)
{
    out.print(os);
    return os;
}
istream& operator >> (istream& is, Student& in)
{
    in.input(is);
    return is;
}
//********************************************
ostream& operator << (ostream& os, Teacher& out)
{
    out.print(os);
    return os;
}
istream& operator >> (istream& is, Teacher& in)
{
    in.input(is);
    return is;
}
//********************************************
ostream& operator << (ostream& os, TeachingAssistant& out)
{
    out.print(os);
    return os;
}
istream& operator >> (istream& is, TeachingAssistant& in)
{
    in.input(is);
    return is;
}
